...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -D__ANDROID_API__=21 -I/home/lgm4st3r/.buildozer/android/platform/android-ndk-r19c/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/arm-linux-androideabi -I/home/lgm4st3r/Python/pwdManager/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/python-installs/pwd-mnger/armeabi-v7a/include/python3.8" ],
  CPPINCLUDES => [  ],
  CXX => "/home/lgm4st3r/.buildozer/android/platform/android-ndk-r19c/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC",
  CXXFLAGS => [ "-target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC" ],
  HASHBANGPERL => "/usr/bin/env perl",
  LDFLAGS => [ "  -L/home/lgm4st3r/Python/pwdManager/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/libs_collections/pwd-mnger/armeabi-v7a" ],
  LDLIBS => [ "-lm" ],
  PERL => "/usr/bin/perl",
  RANLIB => ":",
  RC => "windres",
